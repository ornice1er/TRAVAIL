    ...
    >
      <div class="container-custom">
        <div class="text-center ">
          ...
          >
            L'organe central de gestion et de modernisation de la fonction
            publique béninoise.
          </p>
        </div>
      </div>
      ...
      <div class="container-custom">
        <div class="text-center mb-16 ">
          ...
          <p class="text-xl text-primary-100 dark:text-primary-200">
            L'impact de l'action de la Direction Générale de la Fonction
            Publique
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            >
              ...
              />
              <div
                class="w-full h-full bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center"
                style="display: none;"
              >
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center justify-center space-x-4">
                ...
                <div class="text-left">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    {{ "dgfp@travail.gouv.bj" }}
                  </p>
                </div>
              </div>
              <div class="bg-primary-50 dark:bg-primary-900/20 rounded-lg p-4">
                <p class="text-sm text-primary-700 dark:text-primary-400">
                  <strong>Accueil agents :</strong> Du lundi au vendredi de 8h à
                  16h
                </p>
              </div>
            </div>
