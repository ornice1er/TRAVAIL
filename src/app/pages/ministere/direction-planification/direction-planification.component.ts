      ...
      <div class="container-custom">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div class="">
            <div class="space-y-8">
              ...
              <div class="text-center">
                ...
                <div class="mt-6">
                  <h3 class="text-xl font-bold text-secondary-800 dark:text-secondary-400 mb-2">MALICK Abdoulaziz</h3>
              ...
              <div class="text-center">
                ...
                <div class="mt-6">
                  <h3 class="text-xl font-bold text-secondary-800 dark:text-secondary-400 mb-2">AYEGNON Léonard</h3>
                  <p class="text-gray-600 dark:text-gray-300">Directeur Adjoint</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="">
            ...
            <div class="space-y-6">
              <div>
                <h4 class="font-semibold text-gray-900 dark:text-white mb-3">En matière de planification :</h4>
                <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li class="flex items-start">
                    <span class="w-2 h-2 bg-secondary-600 rounded-full mr-3 mt-2 flex-shrink-0"></span>
                    <span>d'élaborer, de suivre et d'évaluer les plans stratégiques du ministère en liaison avec les structures d'élaboration et de supervision des activités du ministère</span>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="section-padding bg-white dark:bg-gray-900">
      <div class="container-custom">
        <div class="text-center mb-16 ">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300">
            Les métiers et compétences de la Direction de la Planification
          </p>
        </div>
      ...
      <div class="container-custom">
        <div class="text-center mb-16 ">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 mb-8">
            Contactez directement les services spécialisés de la Direction de la Planification
          </p>
        </div>
        ...
        <div class="max-w-2xl mx-auto mt-16 ">
          <div class="card p-8 text-center">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-300 mb-8">
              Pour toute information concernant la planification et les finances.
            </p>
            <div class="space-y-6">
              ...
              <div class="bg-secondary-50 dark:bg-secondary-900/20 rounded-lg p-4">
                <p class="text-sm text-secondary-700 dark:text-secondary-400">
                  <strong>Service budgétaire :</strong> Disponible du lundi au vendredi de 8h à 16h
                </p>
              </div>
            </div>
          </div>
