    ...
    >
      <div class="container-custom">
        <div class="text-center animate-on-scroll">
          ...
          >
            Découvrez le profil de Madame Adidjatou A. MATHYS et son équipe
            gouvernementale.
          </p>
        </div>
      </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="text-center lg:text-left">
                  <div class="relative inline-block">
                    <img
                      src="https://www.travail.gouv.bj/storage/structures/respos/1678790596adidjatou-a-mathys.jpg"
                      alt="Madame Adidjatou A. MATHYS, Ministre du Travail"
                      class="rounded-2xl shadow-lg w-full max-w-md mx-auto"
                    />
                    <div
                      class="absolute -bottom-4 -right-4 w-16 h-16 bg-primary-700 rounded-full flex items-center justify-center"
                    >
                ...
                <div>
                  ...
                  <h3
                    class="text-xl font-semibold text-primary-800 dark:text-primary-400 mb-6"
                  >
                  ...
                  <!-- Biographie -->
                  <div
                    class="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed"
                  >
                    <div
                    ...
                    >
                      <p class="mb-4">
                        Mariée et mère de trois enfants, Mme Adidjatou MATHYS
                        est experte en Finance et en Comptabilité de l'État.
                        Administrateur du Trésor à la retraite, elle peut se
                        targuer d'avoir eu un parcours professionnel élogieux,
                        fait d'une série de promotions, confirmant la
                        reconnaissance de ses mérites.
                      </p>

                      <p class="mb-4">
                        En effet, après l'obtention en 1981 de la Maîtrise
                        ès-Sciences Économiques (option Finances et Fiscalité) à
                        l'Université Nationale du Bénin, Mme Adidjatou MATHYS
                        fut de 1982 à 1983, Assistant du Chef du Service des
                        Affaires Financières du Ministère de l'Enseignement
                        Supérieur et de la Recherche Scientifique.
                      </p>

                      <p class="mb-4">
                        Pour répondre à la maxime selon laquelle les grands
                        esprits ont un but, cette femme battante et confiante en
                        ses capacités à réussir, a poursuivi ses études au CEFAP
                        de 1982 à 1984 et a obtenu le Diplôme en Administration
                        Centrale des Finances et Trésor.
                      </p>

                      <p class="mb-4">
                        À partir de 1984, elle se retrouve à la Direction
                        Générale du Trésor et de la Comptabilité Publique
                        (DGTCP). C'est là qu'elle fit l'essentiel de sa carrière
                        car elle y est restée jusqu'en 2003 et a gravi toutes
                        les marches avant d'accéder au poste de Directrice
                        Générale du Trésor et de la Comptabilité Publique en
                        1999.
                      </p>

                      <p class="mb-4">
                        Avant de se voir confier cette responsabilité, Adidjatou
                        MATHYS a été successivement, Assistant du Receveur du
                        Centre de Recouvrement, Chef Adjoint et ensuite, Chef du
                        Service de la Dépense, Receveur des Finances de l'Ouémé
                        et Directrice Générale Adjointe de la DGTCP.
                      </p>

                      <p class="mb-4">
                        Elle a mis ses expériences accumulées, au service de
                        plusieurs structures, institutions tant au plan national
                        que régional et ce, à travers sa présence dans les
                        organes de décision. Elle fut par exemple membre du
                        Conseil d'Administration de la BCEAO, membre du Conseil
                        de Gérance de la Caisse Autonome d'Amortissement et du
                        Conseil d'Administration de la Continental Bank.
                      </p>

                      <p class="mb-4">
                        À partir de 2006, la vie professionnelle d'Adidjatou
                        MATHYS a pris une autre tournure. Grâce à sa
                        détermination et son engagement, elle est désormais
                        présente dans la grande sphère de décisions sur les
                        questions des finances et de l'économie du Bénin.
                      </p>

                      <p class="mb-4">
                        Avec une compétence avérée, elle fut successivement
                        nommée de 2006 à 2011, Directrice de Cabinet du Ministre
                        Délégué chargé du Budget auprès du Ministre du
                        Développement, de l'Économie et des Finances, et
                        Directrice de Cabinet du Ministre de l'Économie et des
                        Finances.
                      </p>

                      <p class="mb-4">
                        Ayant découvert en elle des qualités et des aptitudes
                        pour un meilleur service à la nation, le Président Boni
                        YAYI la propulse au-devant de la scène publique en la
                        nommant dans son gouvernement en 2012, Ministre de
                        l'Économie et des Finances.
                      </p>

                      <p class="mb-4">
                        Patrice Talon, devenu Président de la République en
                        Avril 2016, l'a rappelé à ses côtés pour la gestion des
                        affaires de l'État. Le Chef de l'État qui ne doute point
                        de ses compétences, lui a confié dans son premier
                        gouvernement, la charge de Ministre du Travail, de la
                        Fonction Publique et des Affaires Sociales.
                      </p>

                      <p>
                        Bien conscient de l'immensité du chantier relatif à la
                        dynamisation et à la modernisation de l'Administration
                        publique Béninoise, le Président Patrice Talon, à
                        l'occasion du remaniement ministériel du 27 octobre
                        2017, a renouvelé toute sa confiance à cette femme de
                        défis en la maintenant à la tête du très stratégique
                    ...
                    <!-- Bouton Lire plus -->
                    <div class="mt-6">
                      <button (click)="toggleBio()" class="btn-primary text-sm">
            ...
            >
              <div class="mb-8">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300">
                  L'équipe dirigeante qui accompagne le Ministre dans l'exercice
                  de ses fonctions.
                </p>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                  *ngFor="let membre of membresCabinet"
                  class="card p-6 text-center animate-on-scroll hover:shadow-lg transition-all duration-300"
                >
                  <!-- Photo -->
                  <div
                    class="w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto mb-4 overflow-hidden"
                  >
                    <img
                      [src]="membre.photo"
                      [alt]="membre.nom"
                    ...
                    />
                    <div
                      class="w-full h-full bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center"
                      style="display: none;"
                    >
                      <span
                  ...
                  <!-- Nom -->
                  <h3
                    class="text-lg font-bold text-primary-800 dark:text-primary-400 mb-2"
                  >
                    {{ membre.nom }}
                  </h3>
      ...
      <div class="container-custom">
        <div class="max-w-2xl mx-auto text-center animate-on-scroll">
          ...
          <p class="text-lg text-primary-100 dark:text-primary-200 mb-8">
            Restez informé des dernières actualités et initiatives du Ministère
            du Travail.
          </p>
          <form
