export const thematiques: any[] = [
  ...
  {
    id: 122,
    libelle: "Difficultés liées aux plateformes en ligne",
  },
  {
    id: 1,
    libelle: "Carrière",
...
export const structures: any[] = [
  {
    id: 1,
    libelle: "Secrétariat Général du Ministère",
    sigle: "SGM",
    slug: "sgm",
    description: "Coordination des activités de l'ensemble du ministère.",
    icone: "🎯",
    lienDetail: "/ministere/secretariat-general",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    libelle: "Cellule de Contrôle des Marchés Publics",
    sigle: "CCMP",
    slug: "ccmp",
    description: "Contrôle des marchés publics.",
    icone: "📝",
    lienDetail: "/ministere/ccmp",
  },
  {
    id: 4,
    libelle: "Caisse Mutuelle de Prévoyance Sociale",
    sigle: "CMPS",
    slug: "cmps",
    description: "Prévoyance sociale des agents de l'état.",
    icone: "🛡️",
    lienDetail: "/ministere/cmps",
  },
  {
    id: 5,
    libelle: "Caisse Nationale de Sécurité Sociale",
    sigle: "CNSS",
    slug: "cnss",
    description: "Sécurité sociale des agents du secteur privé.",
    icone: "🏥",
    lienDetail: "/ministere/cnss",
  },
  {
    id: 9,
    libelle:
      "Direction des Normes du Travail, des Relations Professionnelles et du Dialogue Social",
    sigle: "DNTRPDS",
    slug: "dntrpds",
    description: "Normes du travail et dialogue social.",
    icone: "🤝",
    lienDetail: "/ministere/dntrpds",
  },
  {
    id: 11,
    libelle: "Direction du Recrutement des Agents de l'Etat",
    sigle: "DRAE",
    slug: "drae",
    description: "Recrutement des agents de l'état.",
    icone: "📥",
    lienDetail: "/ministere/drae",
  },
  {
    id: 14,
    libelle:
      "Cellule de Gestion du Fichier Unique de Référence et de la Programmation des Effectifs",
    sigle: "CGFUR-PE",
    slug: "cgfur-pe",
    description: "Gestion du fichier unique de référence.",
    icone: "💾",
    lienDetail: "/ministere/cgfur-pe",
  },
  {
    id: 18,
  ...
  },
  {
    ...
    sigle: "DPAF",
    slug: "dpaf",
    description: "Planification, administration et finances.",
    icone: "💰",
    lienDetail: "/ministere/dpaf",
  },
  {
    id: 23,
  ...
  },
  {
    ...
    sigle: "Cabinet",
    slug: "cabinet",
    description: "Cabinet du ministre.",
    icone: "🧑‍⚖️",
    lienDetail: "/ministere/cabinet",
  },
  {
    id: 25,
    libelle: "Direction Départementale: Cellule Emploi et Micro Finance",
    sigle: "DDCEMF",
    slug: "ddcemf",
    description: "Emploi et micro finance.",
    icone: "📈",
    lienDetail: "/ministere/ddcemf",
  },
  {
    id: 58,
  ...
  {
    id: 70,
    libelle: "Direction des Etudes du Contentieux et du Régime Disciplinaire",
    sigle: "DECRD",
    slug: "decrd",
    description: "Etudes du contentieux et du régime disciplinaire.",
    icone: "⚖️",
    lienDetail: "/ministere/decrd",
  },
  {
    id: 75,
    libelle: "Direction des Retraites et des Archives",
    sigle: "DRA",
    slug: "dra",
    description: "Retraites et des archives.",
    icone: "🗄️",
    lienDetail: "/ministere/dra",
  },
  {
    id: 87,
  ...
  },
  {
    id: 115,
    libelle:
      "Cellule de Suivi des Réformes Administratives et Institutionnelles",
    sigle: "CSRAI",
    slug: "csr",
    description: "Suivi des réformes administratives et institutionnelles.",
    icone: "📊",
    lienDetail: "/ministere/csrai",
  },
  {
    id: 197,
    libelle: "Mairie de Cotonou",
    sigle: "Mairie Cot",
    slug: "mairie-cot",
    description: "Mairie de Cotonou.",
    icone: "🏢",
    lienDetail: "/ministere/mairie-cotonou",
  },
  {
    id: 198,
    libelle: "Mairie  Djidja",
    sigle: "M/Djidja",
    slug: "mairie-djidja",
    description: "Mairie de Djidja.",
    icone: "🏢",
    lienDetail: "/ministere/mairie-djidja",
  },
  {
    id: 199,
    libelle: "Mairie Cove",
    sigle: "M/Cove",
    slug: "mairie-cove",
    description: "Mairie de Cove.",
    icone: "🏢",
    lienDetail: "/ministere/mairie-cove",
  },
  {
    id: 200,
    libelle: "Mairie Abomey",
    sigle: "M/ Abomey",
    slug: "mairie-abomey",
    description: "Mairie de Abomey.",
    icone: "🏢",
    lienDetail: "/ministere/mairie-abomey",
  },
  {
    id: 201,
    libelle: "Mairie Bohicon",
    sigle: "M/Bohicon",
    slug: "mairie-bohicon",
    description: "Mairie de Bohicon.",
    icone: "🏢",
    lienDetail: "/ministere/mairie-bohicon",
  },
];
