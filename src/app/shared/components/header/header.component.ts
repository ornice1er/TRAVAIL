...
import { ThemeService } from '../../services/theme.service';
  ...
  @Component({
    ...
    template: `
      <header [class]="headerClasses" class=" transition-all duration-300">
        ...
        <div class="bg-primary-800 dark:bg-primary-900 text-white text-sm py-2 ease-in-out transition-all delay-100 duration-300" [class.hidden]="isScrolled">
          <div class="container-custom">
            <div class="flex justify-between items-center">
              ...
              <a href="https://www.gouv.bj" target="_blank" class="hover:text-primary-200 dark:hover:text-primary-300 transition-colors">
                www.gouv.bj
              </a>
            </div>
          </div>
        ...
        <nav class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700" [class.shadow-lg]="isScrolled">
          <div class="container-custom">
            <div class="flex justify-between items-center py-4">
              <!-- Logo -->
              <div class="flex items-center space-x-4">
                <img src="assets/logo-mtfp.png" *ngIf="!themeService.isDarkMode" alt="mtfp-logo" class="h-14">
                <img src="assets/logo-mtfp-benin1.png" *ngIf="themeService.isDarkMode" alt="mtfp-logo" class="h-14">
              </div>
            ...
            <!-- Menu mobile -->
            <div *ngIf="isMobileMenuOpen" class="lg:hidden border-t border-gray-200 dark:border-gray-700 py-4">
