<<<<<<<< HEAD:dist/travail/browser/chunk-2UK4P3A2.js
import{a as B}from"./chunk-WEROOGEB.js";import{b as T,e as L,j as z}from"./chunk-SWS6XZUI.js";import"./chunk-JMQIQ26B.js";import{a as O}from"./chunk-XDYLIFGZ.js";import{a as H}from"./chunk-ZUIL5CN3.js";import"./chunk-ATU2I464.js";import{l as E,m as S,t as I,u as D,x as F}from"./chunk-BE5332LF.js";import{Ac as x,Bc as M,Dc as v,Jb as o,Kb as r,Lb as p,Va as b,Vb as u,Wa as C,Za as n,db as g,hc as a,ic as w,jc as m,ka as f,la as y,mb as k,rb as d,sc as _,zb as l}from"./chunk-CRPGZ22B.js";import"./chunk-GAL4ENT6.js";var V=i=>["/communiques",i];function j(i,s){if(i&1&&(o(0,"div",22)(1,"div",23),f(),o(2,"svg",24),p(3,"path",25),r()(),y(),o(4,"div",26)(5,"h5",27),a(6),r(),o(7,"p",28),a(8),x(9,"date"),r()(),o(10,"div",29)(11,"a",30),a(12,"Voir"),r(),o(13,"a",31),a(14,"T\xE9l\xE9charger"),r()()()),i&2){let e=s.$implicit,t=u(4);n(5),l("title",e.title),n(),m(" ",e.title," "),n(2),m(" ",v(9,5,e.created_at,"d MMMM yyyy","fr")," "),n(3),l("href",t.getLink("concours",e.filename),C),n(2),l("href",t.getLink("concours",e.filename),C)}}function P(i,s){if(i&1&&(o(0,"div",18)(1,"h5",19),a(2),r(),o(3,"div",20),d(4,j,15,9,"div",21),r()()),i&2){let e=s.$implicit;n(2),w(e.key),n(2),l("ngForOf",e.value)}}function R(i,s){if(i&1&&(o(0,"section",15)(1,"h4",16),a(2," \u{1F4C4} M\xE9dias associ\xE9s "),r(),d(3,P,5,2,"div",17),x(4,"keyvalue"),r()),i&2){let e=u(2);n(3),l("ngForOf",M(4,1,e.groupFilesByType(e.concour.files)))}}function q(i,s){if(i&1&&(o(0,"div",33)(1,"div",26)(2,"h5",34),a(3),r(),o(4,"p",28),a(5),x(6,"date"),r(),p(7,"p",35),r(),o(8,"div",36)(9,"a",37),a(10,"lire le communiqu\xE9"),r()()()),i&2){let e=s.$implicit;n(3),w(e.title),n(2),m(" ",v(6,4,e.created_at,"d MMMM yyyy","fr")," "),n(2),l("innerHTML",e.sub_description,b),n(2),l("routerLink",_(8,V,e.slug))}}function A(i,s){if(i&1&&(o(0,"section",7)(1,"h4",16),a(2,"\u{1F4E2} Communiqu\xE9s associ\xE9s"),r(),d(3,q,11,10,"div",32),r()),i&2){let e=u(2);n(3),l("ngForOf",e.concour.lists)}}function $(i,s){if(i&1&&(o(0,"div",1)(1,"div",2)(2,"nav",3)(3,"a",4),f(),o(4,"svg",5),p(5,"path",6),r(),a(6," Retour aux concours "),r()(),y(),o(7,"article",7)(8,"header",3)(9,"div",8)(10,"span",9),a(11," Concours "),r(),o(12,"span",10),a(13),x(14,"date"),r()(),o(15,"h1",11),a(16),r()(),p(17,"div",12),d(18,R,5,3,"section",13)(19,A,4,1,"section",14),r()()()),i&2){let e=u();n(13),m(" ",v(14,5,e.concour.created_at,"d MMMM yyyy","fr")," "),n(3),m(" ",e.concour.title," "),n(),l("innerHTML",e.concour.description,b),n(),l("ngIf",e.concour.files==null?null:e.concour.files.length),n(),l("ngIf",e.concour.lists==null?null:e.concour.lists.length)}}var Y=(()=>{class i{constructor(e,t,c){this.route=e,this.publicService=t,this.seo=c,this.concour=null,this.articlesSimilaires=[],this.articles=[],this.medias=[],this.groupedConcoursFiles={},this.networks=[]}ngOnInit(){this.route.params.subscribe(e=>{this.actualiteId=e.id,this.getOneConcours()})}getOneConcours(){this.publicService.getOneConcours(this.actualiteId).subscribe(e=>{this.concour=e.data.concours,this.seo.update({title:this.concour?.title??"Concours",description:this.seo.toDescription(this.concour?.description),type:"article",publishedAt:this.concour?.created_at});let t=e.data.shareLinks;this.concour?.files&&(this.groupedConcoursFiles=this.groupBy(this.concour.concours.files,"type")),this.networks=[{name:"Twitter",url:t.twitter,colorClass:"text-blue-500 hover:text-blue-700",svg:`
========
import{a as B}from"./chunk-DFCY5OYW.js";import{b as T,e as L,j as z}from"./chunk-E5RJCG6D.js";import"./chunk-2GJKY72O.js";import{a as O}from"./chunk-UBBQ66JX.js";import{a as H}from"./chunk-E3VIKNPZ.js";import"./chunk-37KWNW27.js";import{l as E,m as S,t as I,u as D,x as F}from"./chunk-HXPGCBQ2.js";import{Ab as l,Bc as x,Cc as M,Ec as v,Kb as o,Lb as r,Mb as p,Va as b,Wa as C,Wb as u,_a as n,eb as g,ic as a,jc as w,ka as f,kc as m,la as y,nb as k,sb as d,tc as _}from"./chunk-IDE73YBS.js";import"./chunk-GAL4ENT6.js";var V=i=>["/communiques",i];function j(i,s){if(i&1&&(o(0,"div",22)(1,"div",23),f(),o(2,"svg",24),p(3,"path",25),r()(),y(),o(4,"div",26)(5,"h5",27),a(6),r(),o(7,"p",28),a(8),x(9,"date"),r()(),o(10,"div",29)(11,"a",30),a(12,"Voir"),r(),o(13,"a",31),a(14,"T\xE9l\xE9charger"),r()()()),i&2){let e=s.$implicit,t=u(4);n(5),l("title",e.title),n(),m(" ",e.title," "),n(2),m(" ",v(9,5,e.created_at,"d MMMM yyyy","fr")," "),n(3),l("href",t.getLink("concours",e.filename),C),n(2),l("href",t.getLink("concours",e.filename),C)}}function P(i,s){if(i&1&&(o(0,"div",18)(1,"h5",19),a(2),r(),o(3,"div",20),d(4,j,15,9,"div",21),r()()),i&2){let e=s.$implicit;n(2),w(e.key),n(2),l("ngForOf",e.value)}}function R(i,s){if(i&1&&(o(0,"section",15)(1,"h4",16),a(2," \u{1F4C4} M\xE9dias associ\xE9s "),r(),d(3,P,5,2,"div",17),x(4,"keyvalue"),r()),i&2){let e=u(2);n(3),l("ngForOf",M(4,1,e.groupFilesByType(e.concour.files)))}}function q(i,s){if(i&1&&(o(0,"div",33)(1,"div",26)(2,"h5",34),a(3),r(),o(4,"p",28),a(5),x(6,"date"),r(),p(7,"p",35),r(),o(8,"div",36)(9,"a",37),a(10,"lire le communiqu\xE9"),r()()()),i&2){let e=s.$implicit;n(3),w(e.title),n(2),m(" ",v(6,4,e.created_at,"d MMMM yyyy","fr")," "),n(2),l("innerHTML",e.sub_description,b),n(2),l("routerLink",_(8,V,e.slug))}}function A(i,s){if(i&1&&(o(0,"section",7)(1,"h4",16),a(2,"\u{1F4E2} Communiqu\xE9s associ\xE9s"),r(),d(3,q,11,10,"div",32),r()),i&2){let e=u(2);n(3),l("ngForOf",e.concour.lists)}}function $(i,s){if(i&1&&(o(0,"div",1)(1,"div",2)(2,"nav",3)(3,"a",4),f(),o(4,"svg",5),p(5,"path",6),r(),a(6," Retour aux concours "),r()(),y(),o(7,"article",7)(8,"header",3)(9,"div",8)(10,"span",9),a(11," Concours "),r(),o(12,"span",10),a(13),x(14,"date"),r()(),o(15,"h1",11),a(16),r()(),p(17,"div",12),d(18,R,5,3,"section",13)(19,A,4,1,"section",14),r()()()),i&2){let e=u();n(13),m(" ",v(14,5,e.concour.created_at,"d MMMM yyyy","fr")," "),n(3),m(" ",e.concour.title," "),n(),l("innerHTML",e.concour.description,b),n(),l("ngIf",e.concour.files==null?null:e.concour.files.length),n(),l("ngIf",e.concour.lists==null?null:e.concour.lists.length)}}var Y=(()=>{class i{constructor(e,t,c){this.route=e,this.publicService=t,this.seo=c,this.concour=null,this.articlesSimilaires=[],this.articles=[],this.medias=[],this.groupedConcoursFiles={},this.networks=[]}ngOnInit(){this.route.params.subscribe(e=>{this.actualiteId=e.id,this.getOneConcours()})}getOneConcours(){this.publicService.getOneConcours(this.actualiteId).subscribe(e=>{this.concour=e.data.concours,this.seo.update({title:this.concour?.title??"Concours",description:this.seo.toDescription(this.concour?.description),type:"article",publishedAt:this.concour?.created_at});let t=e.data.shareLinks;this.concour?.files&&(this.groupedConcoursFiles=this.groupBy(this.concour.concours.files,"type")),this.networks=[{name:"Twitter",url:t.twitter,colorClass:"text-blue-500 hover:text-blue-700",svg:`
>>>>>>>> pprod:dist/travail/browser/chunk-5X3ARUVP.js
